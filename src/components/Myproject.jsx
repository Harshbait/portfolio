...
const Myproject = () => {
  return (
    <div>
       <div className='rota'><h1 className="absolute text-[60px] sm:text-[10vw] font-[Potfilo2] px-1 py-2 sm:py-5 sm:px-0 text-white">My Projects</h1></div>
       <h1 className='font-bold text-[20px] sm:text-[4vh] mt-23 sm:mt-[28vh]'>I have developed several projects, including:</h1>
       <h1 className='font-[Potfilo1] text-[13px] sm:text-[3vh]'>A real-time chat web application using Socket.io</h1>
