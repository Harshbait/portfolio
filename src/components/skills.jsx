...
const skills = () => {
  return (
    <div>
       <div className="piu sm:w-[40vw] flex items-center justify-center flex-wrap gap-4 ">
          ...
          />
          <img
            src="https://static-00.iconduck.com/assets.00/socket-io-icon-512x511-xjp7kzx6.png"
            className="rotat h-13 sm:h-20 sm:w-20"
            alt="socket.io"/>
          <img
