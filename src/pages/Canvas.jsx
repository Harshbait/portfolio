...
const Canvas = () => {
  ...
  return (
    <canvas
      ref={canvasRef}
      className="h-[20rem] md:h-[30rem] lg:h-[40rem] lg:w-[55rem] absolute md:mt-[30vh] mt-[48vh] lg:mt-0 lg:top-0 md:left-[15vw] left-[-21vw] lg:left-[40vw] z-30 pointer-events-none"
      id="canvas"
    ></canvas>
  );
};
